...
.post(upload.none(), async (req,res,next) => {
    try {
        conn = await oracledb.getConnection(dbConfig);
        conn.execute(`INSERT INTO TB_BOARDMGR (
            brd_mgrno,
            brd_nm,
            brd_snm,
            brd_skin_cd,
            ...
            ${req.body.brd_nm},
            ${req.body.brd_snm},
            ${req.body.brd_skin_cd},
            ${req.body.use_yn},
            ${req.body.list_cnt == undefined || req.body.list_cnt == ''? 10:req.body.list_cnt},
            ${req.body.delflag},
            ${req.body.write_auth_cd},
            ${req.body.attach_file_cnt == undefined || req.body.attach_file_cnt == ''? 0:req.body.attach_file_cnt},
            ${req.body.writer_use_yn},
            ${req.body.email_use_yn},
            ${req.body.term_use_yn},
            ${req.body.secret_use_yn},
            ${req.body.reply_use_yn},
            ${req.body.regdt_use_yn},
            ${req.body.cmt_use_yn},
            ${req.body.thm_width_size},
            ${req.body.thm_height_size},
            ${req.body.brd_desc},
            ${req.body.reg_ip},
            ${req.body.brd_reg_cnt},
            ${req.body.date_use_yn},
            ${req.body.date_title == undefined || req.body.date_title == ''? '날짜':req.body.date_title},
            ${req.body.term_sdt_title == undefined || req.body.term_sdt_title == ''? '시작일':req.body.term_sdt_title},
            ${req.body.term_edt_title == undefined || req.body.term_edt_title == ''? '종료일':req.body.term_edt_title},
            ${req.body.etc_field1_use_yn},
            ${req.body.etc_field1_title},
            ${req.body.etc_field2_use_yn},
            ${req.body.etc_field2_title},
            ${req.body.etc_field3_use_yn},
            ${req.body.etc_field3_title},
            ${req.body.etc_field4_use_yn},
            ${req.body.etc_field4_title},
            ${req.body.url_use_yn},
            ${req.body.popsize_use_yn},
            ${req.body.direct_url_use_yn},
            ${req.body.cate_cd_use_yn},
            ${req.body.cate_cd},
            ${req.body.top_fix_use_yn},
            ${req.body.cate_cd_title == undefined || req.body.cate_cd_title == ''? '카테고리':req.body.cate_cd_title},
            ${req.body.site_gb},
            ${req.body.site_share_yn},
            ${req.body.total_search_use_yn},
            ${req.body.ord_use_yn},
            ${req.body.ctnt_use_yn},
